...
>   欢迎访问「`PanDaoxi`」的介绍！
>   原网页地址：<https://pandaoxi.github.io/>


## `Who`

-   毕业学校：我是来自河北省**石家庄市第二十三中学**（简称：`SJZ23ZH`）的一名 `2022` 级初中学生，毕业于**石家庄市行知小学**。
...
-   座右铭：「**温和中坚持，宁静中创新。**」（这也是 `SJZ23ZH`​ 的教育理念）。
...
-   最喜欢的软件：`Vmware Workstation Pro` 和 `Aptana Studio 3`。
...
|           微信           | `PanDaoxi2021`                                      | 如果想加我微信，请务必注明来意，以及是从这个网站上找到我的。 |
...
|   `Daoxi365`    | [PanDaoxi (gitee.io)](https://pandaoxi.gitee.io/)            | 主博客。                                                     |
|   `Tech Blog`   | [PanDaoxi's Tech Blog (gitee.io)](https://pandaoxi.gitee.io/tech-blog/) | 技术博客。                                                   |
| `Software Blog` | [PanDaoxi's Software Blog (gitee.io)](https://pandaoxi.gitee.io/software/) | 自制软件下载站。                                             |
